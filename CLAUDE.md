...
Sistema de gestão de embarque no ônibus universitário da Unifor: o aluno entra/sai da lista diária pelo app, o admin gerencia rotas e dispara push, o motorista avisa a saída. Projeto de TCC (entrega oficial: início de novembro/2026).
